...
ggsave(filename = here("Conferences", "ISB", "Graphs", "ISB Bar Graph.pdf"),
       plot = Bar_Graph,
       device = "pdf",
       width = 8,
       height = 3,
...
Boxplot <- Master_Box %>% 
  ...
  labs(x = "Structure",
       y = "Percentage of target responses",
       fill = "Group",
       title = "Distribution in Production by Structure and Group") +
  theme(axis.title = element_text(face = "bold"),
        plot.title = element_text(hjust = 0.5, face = "bold"),
        legend.title = element_text(face = "bold"),
        strip.text = element_text(face = "bold"),
...
ggsave(filename = here("Conferences", "ISB", "Graphs", "ISB Boxplot.pdf"),
       plot = Boxplot,
       device = "pdf",
       width = 8,
       height = 3,
